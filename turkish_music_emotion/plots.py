"""
Módulo de visualización de datos que proporciona diversas clases para crear
gráficos estadísticos y análisis visuales.

Este módulo contiene clases especializadas para diferentes tipos de visualizaciones,
incluyendo histogramas, matrices de correlación, boxplots y distribuciones de clases.
"""
